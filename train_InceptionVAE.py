...
from model.InceptionVAE_trainer import InceptionVAE_trainer
import plot_graph
...
if __name__ == '__main__':
    ...
    vae_train =  InceptionVAE_trainer(args.first_channel, args.latent, repeat=args.repeat, batchNorm=args.batchnorm, device=device)
