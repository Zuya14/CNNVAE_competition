...
from .InceptionRedVAE_Leaky import InceptionRedVAE_Leaky

class InceptionRedVAE_Leaky_trainer:

    def __init__(self, first_channel, latent_size, red_times, repeat, channel_inc, device='cpu'):
        self.vae = InceptionRedVAE_Leaky(first_channel, latent_size, red_times, repeat, channel_inc)
