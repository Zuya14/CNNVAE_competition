...
from model.InceptionRedVAE_Leaky_trainer import InceptionRedVAE_Leaky_trainer
import plot_graph
...
if __name__ == '__main__':
    ...
    out_dir = './result-InceptionRedVAE_Leaky' 
    ...
    vae_train =  InceptionRedVAE_Leaky_trainer(args.first_channel, args.latent, red_times=args.red_times, repeat=args.repeat, channel_inc=args.channel_inc, device=device)
